...
namespace IT8_TechStore.UI.Views
{
    public class PosView : UserControl
    {
        ...
        private void InitializeView()
        {
            ...
            // Responsive 2-Column Split (62% Left Product Catalog Grid / 38% Right Active Cart Panel)
            ...
            // ==========================================
            // RIGHT COLUMN: Active Cart Panel & Billing Breakdown
            // ==========================================
        ...
        private void GridCart_CellClick(object? sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 4) // Delete column or action
            {
